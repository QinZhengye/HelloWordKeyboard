...
float EncoderBase::GetVelocity()
{
    ...
    float vel = ((float) (rotationCount - rotationCountLast) * _2PI + (angleLast - velocityLastAngle)) / time;

    // save variables for future pass
    velocityLastAngle = angleLast;
...
void EncoderBase::ResetRotationCount()
{
    rotationCountLast -= rotationCount;
    rotationCount = 0;
}
