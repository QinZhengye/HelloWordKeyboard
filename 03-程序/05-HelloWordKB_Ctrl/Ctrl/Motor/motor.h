...
public:
        ...
        polePairs(_polePairs), phaseResistance(_phaseResistance)
    {
        ...
        config.lpfVelocity = LowPassFilter{0.05f};
        config.lpfAngle = LowPassFilter{0.01f};
        config.lpfLapAngle = LowPassFilter{0.01f};
